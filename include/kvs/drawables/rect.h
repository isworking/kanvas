...
KVS_API kvs_size kvs_drawable_rect_get_size(const kvs_drawable *drawable);

KVS_API void kvs_drawable_rect_set_width(kvs_drawable *drawable, int width);
KVS_API int kvs_drawable_rect_get_width(const kvs_drawable *drawable);

KVS_API void kvs_drawable_rect_set_height(kvs_drawable *drawable, int height);
KVS_API int kvs_drawable_rect_get_height(const kvs_drawable *drawable);
