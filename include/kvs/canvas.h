...
KVS_API kvs_drawable *kvs_canvas_node_get_drawable(kvs_canvas_node *node);

KVS_API void kvs_canvas_node_set_visible(kvs_canvas_node *node, bool visible);
KVS_API bool kvs_canvas_node_get_visible(kvs_canvas_node *node);

KVS_API void kvs_canvas_node_set_opacity(kvs_canvas_node *node, float opacity);
KVS_API float kvs_canvas_node_get_opacity(kvs_canvas_node *node);

KVS_API void kvs_canvas_node_set_position(kvs_canvas_node *node, kvs_pos position);
KVS_API kvs_pos kvs_canvas_node_get_position(kvs_canvas_node *node);

KVS_API void kvs_canvas_node_set_next(kvs_canvas_node *node, kvs_canvas_node *next);
KVS_API kvs_canvas_node *kvs_canvas_node_get_next(kvs_canvas_node *node);

KVS_API kvs_canvas *kvs_canvas_create(kvs_size size);
KVS_API kvs_canvas *kvs_canvas_create_from_image(kvs_image *image);

KVS_API kvs_size kvs_canvas_get_size(kvs_canvas *canvas);
KVS_API int kvs_canvas_get_width(kvs_canvas *canvas);
KVS_API int kvs_canvas_get_height(kvs_canvas *canvas);

KVS_API kvs_color *kvs_canvas_get_pixels(kvs_canvas *canvas);
KVS_API void kvs_canvas_set_pixel_blend(kvs_canvas *canvas, kvs_pos position, kvs_color color);
KVS_API kvs_color kvs_canvas_get_pixel(kvs_canvas *canvas, kvs_pos position);

KVS_API void kvs_canvas_set_head(kvs_canvas *canvas, kvs_canvas_node *node);
KVS_API kvs_canvas_node *kvs_canvas_get_head(kvs_canvas *canvas);

KVS_API void kvs_canvas_set_tail(kvs_canvas *canvas, kvs_canvas_node *node);
KVS_API kvs_canvas_node *kvs_canvas_get_tail(kvs_canvas *canvas);
